const story = [
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "Stay. Face what Riven has planned.",
        "path": "continueToChoice"
      },
      {
        "text": "Leave. You can't do this. End it yourself.",
        "path": "harvestEnd"
      }
    ]
  },
  ...
  {
    "text": "Riven sets the device down, not in your hand yet. “Before we end this,” she says, “choose what you become.”",
    "section": "majorBranch",
    "isChoice": true,
    "prompt": "Choose your path.",
    "choices": [
      {
        "text": "The Runner (underground network).",
        "path": "runnerPath"
      },
      {
        "text": "The Animal (snap).",
        "path": "animalPath"
      },
      {
        "text": "Skip to final upload choice.",
        "path": "continueToFinalChoice"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "choices": [
      {
        "text": "Complete the upload. Erase yourself. It's what you deserve.",
        "path": "uploadEnd"
      },
      {
        "text": "Abort the upload. Keep existing. Keep being the monster you are.",
        "path": "abortEnd"
      }
    ]
  }
...
const paths = {
  "runnerPath": [
    {
      "text": "PATH A: THE RUNNER",
      "section": "runnerPath",
      "ambientLight": "neon-blue"
    },
    {
      "text": "A broker contacts you through a dead channel. A voice like sandpaper and static.",
      "section": "runnerPath"
    },
    {
      "text": "BROKER: Want to disappear? I can make you a ghost. But ghosts still bleed.",
      "section": "runnerPath"
    },
    {
      "text": "He offers a route beyond the walls—and a list of runners already moving supplies for the resistance.",
      "section": "runnerPath"
    },
    {
      "text": "The broker slides a burner chip across the table. It holds three routes—and one trap.",
      "section": "runnerChoice",
      "isChoice": true,
      "prompt": "Pick your route.",
      "choices": [
        {
          "text": "Take the wasteland route with Riven.",
          "path": "disappearedEnd"
        },
        {
          "text": "Ping corporate security and trade Riven for safe passage.",
          "path": "selloutEnd"
        },
        {
          "text": "Walk away. End it on the bridge.",
          "path": "dropEnd"
        }
      ]
    }
  ...
  "animalPath": [
    {
      "text": "PATH B: THE ANIMAL",
      "section": "animalPath",
      "ambientLight": "danger-red"
    },
    {
      "text": "Something in you snaps. Not courage—just rage.",
      "section": "animalPath"
    },
    {
      "text": "Riven reads it instantly. The decision you're about to make.",
      "section": "animalChoice",
      "isChoice": true,
      "prompt": "What do you do?",
      "choices": [
        {
...
const endings = {
  "harvestEnd": [
    {
      "text": "You pull the cables out. Stand up.",
      "section": "harvestEnd"
    },
    {
      "text": "Mechanic: Where are you going?",
      "section": "harvestEnd"
    },
    {
      "text": "Ash: I can't do this. Any of this.",
      "section": "harvestEnd"
    },
    {
      "text": "Mechanic: You're running. Again.",
      "section": "harvestEnd"
    },
    {
      "text": "Ash: Yeah.",
    ...
    {
      "text": "You leave. She doesn't stop you. Why would she?",
      "section": "harvestEnd",
      "ambientLight": "neon-blue"
    },
    {
      "text": "You walk the streets. Hours. The guilt is crushing. Physical weight.",
      "section": "harvestEnd"
    },
    {
      "text": "Her hands. The saw. Her screaming. It loops. Won't stop.",
      "section": "harvestEnd",
      "glitch": true
    },
    {
      "text": "You can't live with this. Can't die with it. Can't escape it.",
      "section": "harvestEnd"
    },
    {
      "text": "Then you remember. Memory brokers. The ones who buy from desperate runners.",
      "section": "harvestEnd",
      "ambientLight": "neon-red"
    },
    {
      "text": "You know the address. You've sold to them before.",
      "section": "harvestEnd"
    },
    {
      "text": "The office is in the corporate district. Clean. Legal. Sanitized evil.",
      "section": "harvestEnd",
      "ambientLight": "neon-cyan"
    },
    {
      "text": "Broker: You're selling? Or buying?",
      "section": "harvestEnd"
    },
    {
      "text": "Ash: Selling. Everything. Full extraction.",
      "section": "harvestEnd"
    },
    {
      "text": "Broker: Full extraction? That's permanent. You understand that?",
      "section": "harvestEnd"
    },
    {
      "text": "Ash: I understand.",
      "section": "harvestEnd"
    },
    {
      "text": "Broker: You'll be alive. Functional. But empty. Corporate property.",
      "section": "harvestEnd"
    },
    {
      "text": "Ash: How much?",
    ...
    {
      "text": "The broker checks your neural signature. Your memory quality. Your history.",
      "section": "harvestEnd"
    },
    {
      "text": "Broker: You're a runner. Good quality memories. Recent trauma. High value.",
      "section": "harvestEnd"
    },
    {
      "text": "Broker: Fifty thousand credits. We'll wire it to any account you specify.",
      "section": "harvestEnd"
    },
    {
      "text": "You send her information. Riven's signature. Everything goes to her.",
      "section": "harvestEnd"
    },
    {
      "text": "Broker: Interesting choice. Sign here.",
      "section": "harvestEnd"
    },
    {
      "text": "You sign. Digital contract. Legally binding. No going back.",
      "section": "harvestEnd",
      "ambientLight": "danger-red"
    },
    {
      "text": "They take you to a medical room. Clean. White. Like the room where they took her hands.",
      "section": "harvestEnd"
    },
    {
      "text": "You lie down. They strap you in. Not for safety. To prevent resistance.",
      "section": "harvestEnd"
    },
    {
      "text": "Technician: This will hurt. We don't use anesthetic. Memory quality degrades.",
      "section": "harvestEnd"
    },
    {
      "text": "Ash: I know. I've sold to you before. Other people's memories.",
      "section": "harvestEnd"
    },
    {
      "text": "Technician: Full circle then.",
      "section": "harvestEnd"
    },
    {
      "text": "They connect the extraction array. Multiple cables. Deep neural access.",
      "section": "harvestEnd",
      "glitch": true
    },
    {
      "text": "The extraction starts. It feels like drowning from the inside.",
      "section": "harvestEnd"
    },
    {
      "text": "Your memories pulling out. One by one. Raw. Bleeding.",
      "section": "harvestEnd"
    },
    {
      "text": "Childhood. Gone. First job. Gone. Her face. Her hands. Her screaming.",
      "section": "harvestEnd"
    },
    {
      "text": "Everything. Gone.",
      "section": "harvestEnd"
    },
    {
      "text": "You scream. Everyone does. The technician doesn't stop. They never do.",
      "section": "harvestEnd",
      "ambientLight": "memory-flash"
    },
    {
      "text": "This is what you did to others. For years. And now it's happening to you.",
      "section": "harvestEnd"
    },
    {
      "text": "Perfect symmetry. Perfect justice.",
      "section": "harvestEnd"
    },
    {
      "text": "The extraction takes four hours. You're awake for all of it.",
      "section": "harvestEnd"
    },
    {
      "text": "When it's done, you're still breathing. Heart still beating.",
      "section": "harvestEnd",
      "ambientLight": "neon-blue"
    },
    {
      "text": "But you're not there anymore. Just meat. Just storage.",
      "section": "harvestEnd"
    },
    {
      "text": "They tattoo a barcode on your neck. Corporate property. Asset #447821.",
      "section": "harvestEnd"
    },
    {
      "text": "They assign you to a data center. You'll store corporate files now.",
      "section": "harvestEnd"
    },
    {
      "text": "Just like the woman you saw begging outside the transit station. The one you walked past.",
      "section": "harvestEnd"
    },
    {
      "text": "You're her now. You're all of them.",
      "section": "harvestEnd",
      "ambientLight": "cold-purple"
    },
    {
    ...
    {
      "text": "Riven receives a payment notification. Fifty thousand credits. Anonymous source.",
      "section": "harvestEnd"
    },
    {
      "text": "She traces it. Corporate memory broker. Recent sale. Full extraction.",
      "section": "harvestEnd"
    },
    {
      "text": "Neural signature matches: Ash.",
      "section": "harvestEnd"
    },
    {
      "text": "She finds you three weeks later. Data center sublevel. Row 47.",
      "section": "harvestEnd"
    },
    {
      "text": "You're sitting. Cables in your head. Empty eyes. Drooling slightly.",
      "section": "harvestEnd"
    },
    {
      "text": "She stands in front of you. You don't recognize her. Don't recognize anything.",
      "section": "harvestEnd"
    },
    {
      "text": "Riven: You took the coward's way out. Even in this.",
      "section": "harvestEnd"
    },
    {
      "text": "You don't respond. Can't respond. There's nothing left to respond with.",
      "section": "harvestEnd"
    },
    {
      "text": "Riven: The money... you sent it to me. Why?",
      "section": "harvestEnd"
    },
    {
      "text": "Silence. Just the hum of servers. Data flowing through your empty mind.",
      "section": "harvestEnd"
    },
    {
      "text": "Riven: It wasn't enough. It'll never be enough.",
      "section": "harvestEnd",
      "ambientLight": "cold-purple"
    },
    {
      "text": "She leaves. Doesn't look back.",
      "section": "harvestEnd"
    },
    {
      "text": "You stay. You'll stay forever. Corporate property can't self-terminate.",
      "section": "harvestEnd"
    },
    {
      "text": "The city claimed another runner. Turned them into product. Like it always does.",
      "section": "harvestEnd"
    },
    {
      "text": "The cycle continues. It always does.",
      "section": "harvestEnd",
      "ambientLight": "death-fade"
    },
    {
      "text": "ENDING 7: THE HARVEST",
      "section": "end"
    }
  ],
  "uploadEnd": [
  ...
  "dropEnd": [
    {
      "text": "You climb the railing before you can think. The city hums below you like a hungry machine.",
      "section": "dropEnd"
    },
    {
      "text": "You jump early. No speech. No redemption. Just gravity.",
      "section": "dropEnd"
    },
    {
      "text": "The impact is quick. The neon blurs to black.",
      "section": "dropEnd",
      "ambientLight": "death-fade"
    },
    {
      "text": "ENDING: THE DROP",
      "section": "end"
    }
  ],
  "disappearedEnd": [
    {
      "text": "Riven doesn't forgive you. But she doesn't let the corporation take you either.",
      "section": "disappearedEnd"
    },
    {
      "text": "You leave the city through a service tunnel that smells like wet concrete and old electricity.",
      "section": "disappearedEnd"
    },
    {
      "text": "Outside the walls, the world is quiet. Empty. Real.",
      "section": "disappearedEnd"
    },
    {
      "text": "You don't know what comes next. Only that the city can't reach you here. Not yet.",
      "section": "disappearedEnd",
      "ambientLight": "cold-purple"
    },
    {
      "text": "ENDING: THE DISAPPEARED",
      "section": "end"
    }
  ],
  "selloutEnd": [
    {
      "text": "You sell her out. A clean ping to a corporate channel you swore you'd never use again.",
      "section": "selloutEnd"
    },
    {
      "text": "They arrive fast—too fast. They were already close.",
      "section": "selloutEnd",
      "ambientLight": "danger-red"
    },
    {
      "text": "Riven looks at you once. Not angry. Just… done.",
      "section": "selloutEnd"
    },
    {
      "text": "They pay you. They brand you. They own you again.",
      "section": "selloutEnd"
    },
    {
      "text": "ENDING: THE SELLOUT",
      "section": "end"
    }
  ],
  "deservedEnd": [
    {
      "text": "You lunge for her. A stupid, desperate move.",
      "section": "deservedEnd"
    },
    {
      "text": "Riven doesn't hesitate. One shot. One clean correction.",
      "section": "deservedEnd"
    },
    {
      "text": "You die instantly. Mercy you didn't earn.",
      "section": "deservedEnd",
      "ambientLight": "death-fade"
    },
    {
      "text": "ENDING: THE DESERVED",
      "section": "end"
    }
  ]
};
...
let introScreen, startBtn, storyWrapper, storyText, continueBtn;
let choiceContainer, choicePrompt;
let progressFill, glitchOverlay, ambientLights;
...
function setAmbientLight(lightClass) {
  ...
  ambientLights.className = 'ambient-lights' + (lightClass ? (' active ' + lightClass) : '');
}

function clearChoiceButtons() {
  if (!choiceContainer) return;
  const keep = new Set(['choice-prompt']);
  Array.from(choiceContainer.children).forEach((el) => {
...
function renderChoices(current) {
  if (!choiceContainer) return;
  clearChoiceButtons();
  if (choicePrompt) choicePrompt.textContent = current.prompt || '';

  (current.choices || []).forEach((c) => {
    const btn = document.createElement('button');
    btn.className = 'choice-btn';
    btn.textContent = c.text;
    btn.addEventListener('click', () => makeChoice(c.path));
...
function displayStory() {
  ...
  if (current.ambientLight) setAmbientLight(current.ambientLight);
  if (current.glitch) {
    storyText?.classList.add('glitch');
    if (glitchOverlay) glitchOverlay.style.opacity = '0.3';
    setTimeout(() => {
  ...
  if (storyText) {
    ...
    setTimeout(() => {
      ...
      storyText.style.opacity = '1';
      updateProgress();
      if (current.section === 'end' && continueBtn) {
...
function makeChoice(path) {
  ...
  if (path === 'continueToChoice' || path === 'continueToFinalChoice') {
    currentIndex++;
    while (currentIndex < currentPath.length) {
      const seg = currentPath[currentIndex];
      if (path === 'continueToFinalChoice' && seg.section === 'finalChoice') break;
      if (seg.isChoice) break;
      currentIndex++;
    }
    choiceMade = false;
    choiceContainer?.classList.add('hidden');
...
function updateProgress() {
  ...
  const denom = Math.max(1, currentPath.length - 1);
  progressFill.style.width = ((currentIndex / denom) * 100) + '%';
}
